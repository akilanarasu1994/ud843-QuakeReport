...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        // Try to parse the SAMPLE_JSON_RESPONSE. If there's a problem with the way JSON
        // is formatted, a JSONException exception object will be thrown.
        // Catch the exception so that the app doesn't crash, and print the error message
        // to the logs.
        try {
            // TODO: Parse the response given by the SAMPLE_JSON_RESPONSE string and build up
            // a list of Earthquake objects with the corresponding data.
